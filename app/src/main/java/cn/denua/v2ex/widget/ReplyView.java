...
public class ReplyView extends FrameLayout {
    ...
    private void bindView() {
        mUserPic = findViewById(R.id.iv_user_pic);
        mUserName = findViewById(R.id.tv_username);
        mAgo = findViewById(R.id.tv_ago);
        mVia = findViewById(R.id.tv_via);
        mLikeCount = findViewById(R.id.tv_like);
        mContent = findViewById(R.id.tv_content);
        mFloor = findViewById(R.id.tv_floor);
        mPoster = findViewById(R.id.tv_poster);
        mLike = findViewById(R.id.iv_like);
    }
